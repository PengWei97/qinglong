...
my_filename = "bi_cpfem_v1"
my_filename2 = "bi_cpfem_v1"
...
[UserObjects]
  ...
  [../]
  [./grain_tracker]
    type = GrainTrackerElasticity # TODO ~ 
...
[Materials]
  ...
  [../]
  [./ElasticityTensor]
    type = ComputePolycrystalElasticityTensor # TODO ~ ComputeElasticityTensorCPPF
    grain_tracker = grain_tracker
  [../]
  [./strain]
  ...
  [../]
  [./stress]
    type = ComputeLinearElasticStress # ComputePolycrystalCrystalPlasticityStress
    block = 0
  [../]
[]
