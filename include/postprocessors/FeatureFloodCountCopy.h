 ...
 */
class FeatureFloodCountCopy : public GeneralPostprocessor,
                              public Coupleable,
...
public:
  ...
  FeatureFloodCountCopy(const InputParameters & parameters);
...
protected:
   ...
   * across time steps. The FeatureFloodCountCopyer however does not. This container is here so that
...
template <>
void dataStore(std::ostream & stream, FeatureFloodCountCopy::FeatureData & feature, void * context);
template <>
void dataStore(std::ostream & stream, BoundingBox & bbox, void * context);

template <>
void dataLoad(std::istream & stream, FeatureFloodCountCopy::FeatureData & feature, void * context);
template <>
void dataLoad(std::istream & stream, BoundingBox & bbox, void * context);

template <>
struct enable_bitmask_operators<FeatureFloodCountCopy::Status>
{
  static const bool enable = true;
};

template <>
struct enable_bitmask_operators<FeatureFloodCountCopy::BoundaryIntersection>
{
  static const bool enable = true;
};