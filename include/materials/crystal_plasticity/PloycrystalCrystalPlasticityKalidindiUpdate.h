...
class PloycrystalCrystalPlasticityKalidindiUpdate;

/**
 * PloycrystalCrystalPlasticityKalidindiUpdate uses the multiplicative decomposition of the
...
class PloycrystalCrystalPlasticityKalidindiUpdate : public CrystalPlasticityStressUpdateBase
{
public:
  static InputParameters validParams();

  PloycrystalCrystalPlasticityKalidindiUpdate(const InputParameters & parameters);
