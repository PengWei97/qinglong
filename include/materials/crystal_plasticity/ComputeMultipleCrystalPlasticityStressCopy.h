...
/**
 * ComputeMultipleCrystalPlasticityStressCopy (used together with CrystalPlasticityStressUpdateBaseCopy)
 ...
 */
class ComputeMultipleCrystalPlasticityStressCopy : public ComputeFiniteStrainElasticStress
{
public:
  static InputParameters validParams();

  ComputeMultipleCrystalPlasticityStressCopy(const InputParameters & parameters);
...
protected:
  ...
  std::vector<CrystalPlasticityStressUpdateBaseCopy *> _models;
