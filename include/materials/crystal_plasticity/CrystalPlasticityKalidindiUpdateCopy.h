...
/**
 * CrystalPlasticityKalidindiUpdateCopy uses the multiplicative decomposition of the
...
class CrystalPlasticityKalidindiUpdateCopy : public CrystalPlasticityStressUpdateBaseCopy
{
public:
  static InputParameters validParams();

  CrystalPlasticityKalidindiUpdateCopy(const InputParameters & parameters);
