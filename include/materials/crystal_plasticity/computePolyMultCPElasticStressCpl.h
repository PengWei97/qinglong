...
/**
 * computePolyMultCPElasticStressCpl (used together with CrystalPlasticityStressUpdateBase)
 ...
 */
class computePolyMultCPElasticStressCpl : public ComputeFiniteStrainElasticStress
{
public:
  static InputParameters validParams();

  computePolyMultCPElasticStressCpl(const InputParameters & parameters);
...
protected:
   ...
   */
  virtual void initQpStatefulProperties() override; // END
