...
class PolycrystalCPKalidindiUpdate;

/**
 * PolycrystalCPKalidindiUpdate uses the multiplicative decomposition of the
...
class PolycrystalCPKalidindiUpdate : public CrystalPlasticityStressUpdateBase
{
public:
  static InputParameters validParams();

  PolycrystalCPKalidindiUpdate(const InputParameters & parameters);
