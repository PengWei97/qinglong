...
/**
 * ComputePolycrystalCrystalPlasticityStress (used together with CrystalPlasticityStressUpdateBase)
 ...
 */
class ComputePolycrystalCrystalPlasticityStress : public ComputeFiniteStrainElasticStress
{
public:
