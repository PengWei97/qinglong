...
/**
 * CPKalidindiCplUpdate uses the multiplicative decomposition of the
...
class CPKalidindiCplUpdate : public CrystalPlasticityStressUpdateBase
{
public:
  static InputParameters validParams();

  CPKalidindiCplUpdate(const InputParameters & parameters);
