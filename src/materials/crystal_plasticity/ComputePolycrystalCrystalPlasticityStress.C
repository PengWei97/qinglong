...
void
ComputePolycrystalCrystalPlasticityStress::initQpStatefulProperties()
{
...
void
ComputePolycrystalCrystalPlasticityStress::initialSetup()
{
  ...
  for (unsigned int i = 0; i < _num_models; ++i)
  {
    ...
    if (model)
    {
      ...
      mooseError("Model " + model_names[i] +
                 " is not compatible with ComputePolycrystalCrystalPlasticityStress");
  }
...
void
ComputePolycrystalCrystalPlasticityStress::updateStress(RankTwoTensor & cauchy_stress,
                                                     RankFourTensor & jacobian_mult)
{
  ...
  do
  {
    ...
    if (substep_iter > _max_substep_iter && _convergence_failed)
      mooseException("ComputePolycrystalCrystalPlasticityStress: Constitutive failure");
...
void
ComputePolycrystalCrystalPlasticityStress::preSolveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
...
void
ComputePolycrystalCrystalPlasticityStress::solveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
  {
...
void
ComputePolycrystalCrystalPlasticityStress::postSolveQp(RankTwoTensor & cauchy_stress,
                                                    RankFourTensor & jacobian_mult)
{
...
void
ComputePolycrystalCrystalPlasticityStress::solveStateVariables()
{
  ...
  do
  {
    ...
    {
      if (_print_convergence_message)
        mooseWarning("ComputePolycrystalCrystalPlasticityStress: State variables (or the system "
  ...
  if (iteration == _maxiterg)
  {
    if (_print_convergence_message)
      mooseWarning(
          "ComputePolycrystalCrystalPlasticityStress: Hardness Integration error. Reached the "
...
void
ComputePolycrystalCrystalPlasticityStress::solveStress()
{
  ...
  {
    if (_print_convergence_message)
      mooseWarning("ComputePolycrystalCrystalPlasticityStress: the slip increment exceeds tolerance "
                   "at element ",
                   _current_elem->id(),
                   " and Gauss point ",
                   _qp);
  ...
  while (rnorm > _rtol * rnorm0 && rnorm > _abs_tol && iteration < _maxiter)
  {
    ...
    {
      if (_print_convergence_message)
        mooseWarning("ComputePolycrystalCrystalPlasticityStress: Failed with line search");
  ...
  {
    if (_print_convergence_message)
      mooseWarning("ComputePolycrystalCrystalPlasticityStress: Stress Integration error rmax = ",
                   rnorm,
...
void
ComputePolycrystalCrystalPlasticityStress::calculateResidualAndJacobian()
{
  calculateResidual();
  if (_convergence_failed)
    return;
...
void
ComputePolycrystalCrystalPlasticityStress::calculateResidual()
{
...
void
ComputePolycrystalCrystalPlasticityStress::calculateJacobian()
{
...
void
ComputePolycrystalCrystalPlasticityStress::calcTangentModuli(RankFourTensor & jacobian_mult)
{
...
void
ComputePolycrystalCrystalPlasticityStress::elastoPlasticTangentModuli(RankFourTensor & jacobian_mult)
{
...
void
ComputePolycrystalCrystalPlasticityStress::elasticTangentModuli(RankFourTensor & jacobian_mult)
{
...
bool
ComputePolycrystalCrystalPlasticityStress::lineSearchUpdate(const Real & rnorm_prev,
...
void
ComputePolycrystalCrystalPlasticityStress::calculateEigenstrainDeformationGrad()
{
  _inverse_eigenstrain_deformation_grad.zero();
  _inverse_eigenstrain_deformation_grad.addIa(1.0);
