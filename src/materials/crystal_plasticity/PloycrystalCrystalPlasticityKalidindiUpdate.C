...
#include "PloycrystalCrystalPlasticityKalidindiUpdate.h"
#include "libmesh/int_range.h"

registerMooseObject("TensorMechanicsApp", PloycrystalCrystalPlasticityKalidindiUpdate);

InputParameters
PloycrystalCrystalPlasticityKalidindiUpdate::validParams()
{
...
PloycrystalCrystalPlasticityKalidindiUpdate::PloycrystalCrystalPlasticityKalidindiUpdate(
...
void
PloycrystalCrystalPlasticityKalidindiUpdate::initQpStatefulProperties()
{
...
void
PloycrystalCrystalPlasticityKalidindiUpdate::setInitialConstitutiveVariableValues()
{
...
void
PloycrystalCrystalPlasticityKalidindiUpdate::setSubstepConstitutiveVariableValues()
{
...
bool
PloycrystalCrystalPlasticityKalidindiUpdate::calculateSlipRate()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
void
PloycrystalCrystalPlasticityKalidindiUpdate::calculateEquivalentSlipIncrement(
...
void
PloycrystalCrystalPlasticityKalidindiUpdate::calculateConstitutiveSlipDerivative(
...
bool
PloycrystalCrystalPlasticityKalidindiUpdate::areConstitutiveStateVariablesConverged()
{
...
void
PloycrystalCrystalPlasticityKalidindiUpdate::updateSubstepConstitutiveVariableValues()
{
  // Would also set substepped dislocation densities here if included in this model
...
void
PloycrystalCrystalPlasticityKalidindiUpdate::cacheStateVariablesBeforeUpdate()
{
  _slip_resistance_before_update = _slip_resistance[_qp];
}

void
PloycrystalCrystalPlasticityKalidindiUpdate::calculateStateVariableEvolutionRateComponent()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
bool
PloycrystalCrystalPlasticityKalidindiUpdate::updateStateVariables()
{
