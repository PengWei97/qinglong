...
registerMooseObject("TensorMechanicsApp", ComputePolycrystalElasticityTensorCP);

InputParameters
ComputePolycrystalElasticityTensorCP::validParams()
{
...
void
ComputePolycrystalElasticityTensorCP::initQpStatefulProperties()
{
  if (!_user_provided_rotation_matrix)
  {
    assignEulerAngles();
