...
InputParameters
CrystalPlasticityKalidindiUpdateCopy::validParams()
{
  InputParameters params = CrystalPlasticityStressUpdateBaseCopy::validParams();
...
CrystalPlasticityKalidindiUpdateCopy::CrystalPlasticityKalidindiUpdateCopy(
    const InputParameters & parameters)
  : CrystalPlasticityStressUpdateBaseCopy(parameters),
    // Constitutive values
    _r(getParam<Real>("r")),
    _h(getParam<Real>("h")),
...
{
  // _tau[_qp] _flow_direction[_qp] _slip_resistance[_qp] _slip_increment[_qp]
  // MaterialProperty<std::vector<Real>> & _slip_resistance;
  CrystalPlasticityStressUpdateBaseCopy::initQpStatefulProperties();

  _slip_resistance_copy[_qp].resize(_number_slip_systems);
...
void
CrystalPlasticityKalidindiUpdateCopy::setSubstepConstitutiveVariableValues()
{
...
bool
CrystalPlasticityKalidindiUpdateCopy::calculateSlipRate()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
void
CrystalPlasticityKalidindiUpdateCopy::calculateEquivalentSlipIncrement(
    RankTwoTensor & equivalent_slip_increment)
{
  if (_include_twinning_in_Lp)
  {
    ...
    CrystalPlasticityStressUpdateBaseCopy::calculateEquivalentSlipIncrement(equivalent_slip_increment);
}

void
CrystalPlasticityKalidindiUpdateCopy::calculateConstitutiveSlipDerivative(
...
bool
CrystalPlasticityKalidindiUpdateCopy::areConstitutiveStateVariablesConverged()
{
...
void
CrystalPlasticityKalidindiUpdateCopy::updateSubstepConstitutiveVariableValues()
{
  // Would also set substepped dislocation densities here if included in this model
...
void
CrystalPlasticityKalidindiUpdateCopy::cacheStateVariablesBeforeUpdate()
{
  _slip_resistance_before_update = _slip_resistance[_qp];
}

void
CrystalPlasticityKalidindiUpdateCopy::calculateStateVariableEvolutionRateComponent()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
bool
CrystalPlasticityKalidindiUpdateCopy::updateStateVariables()
{
