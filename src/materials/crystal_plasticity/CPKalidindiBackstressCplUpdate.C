...
#include "CPKalidindiBackstressCplUpdate.h"
#include "libmesh/int_range.h"

registerMooseObject("TensorMechanicsApp", CPKalidindiBackstressCplUpdate);
...
CPKalidindiBackstressCplUpdate::CPKalidindiBackstressCplUpdate(const InputParameters & parameters)
...
void
CPKalidindiBackstressCplUpdate::initQpStatefulProperties()
{
...
void
CPKalidindiBackstressCplUpdate::setInitialConstitutiveVariableValues()
{
