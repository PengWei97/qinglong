...
#include "PolycrystalCPKalidindiUpdate.h"
#include "libmesh/int_range.h"

registerMooseObject("TensorMechanicsApp", PolycrystalCPKalidindiUpdate);

InputParameters
PolycrystalCPKalidindiUpdate::validParams()
{
...
PolycrystalCPKalidindiUpdate::PolycrystalCPKalidindiUpdate(
...
void
PolycrystalCPKalidindiUpdate::initQpStatefulProperties()
{
...
void
PolycrystalCPKalidindiUpdate::setInitialConstitutiveVariableValues()
{
...
void
PolycrystalCPKalidindiUpdate::setSubstepConstitutiveVariableValues()
{
...
bool
PolycrystalCPKalidindiUpdate::calculateSlipRate()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
void
PolycrystalCPKalidindiUpdate::calculateEquivalentSlipIncrement(
...
void
PolycrystalCPKalidindiUpdate::calculateConstitutiveSlipDerivative(
...
bool
PolycrystalCPKalidindiUpdate::areConstitutiveStateVariablesConverged()
{
...
void
PolycrystalCPKalidindiUpdate::updateSubstepConstitutiveVariableValues()
{
  // Would also set substepped dislocation densities here if included in this model
...
void
PolycrystalCPKalidindiUpdate::cacheStateVariablesBeforeUpdate()
{
  _slip_resistance_before_update = _slip_resistance[_qp];
}

void
PolycrystalCPKalidindiUpdate::calculateStateVariableEvolutionRateComponent()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
bool
PolycrystalCPKalidindiUpdate::updateStateVariables()
{
