...
registerMooseObject("qinglongApp", GrainPropertyReadFileCP);

InputParameters
GrainPropertyReadFileCP::validParams()
{
...
GrainPropertyReadFileCP::GrainPropertyReadFileCP(const InputParameters & parameters)
...
void
GrainPropertyReadFileCP::readElementData()
{
...
void
GrainPropertyReadFileCP::readGrainData()
{
...
void
GrainPropertyReadFileCP::initGrainCenterPoints()
{
...
Real
GrainPropertyReadFileCP::getData(const Elem * elem, unsigned int prop_num) const
{
...
Real
GrainPropertyReadFileCP::getElementData(const Elem * elem, unsigned int prop_num) const
{
...
Real
GrainPropertyReadFileCP::getGrainData(const Elem * elem, unsigned int prop_num) const
{
  mooseAssert(prop_num < _nprop,
              "Error ElementPropertyReadFile: Property number "
                  << prop_num << " greater than total number of properties " << _nprop
...
Real
GrainPropertyReadFileCP::getIndexGrainData(const Elem * elem, unsigned int prop_num) const
{
...
Real
GrainPropertyReadFileCP::minPeriodicDistance(Point c, Point p) const
{
  Point dist_vec = c - p;
