...
registerMooseObject("PhaseFieldApp", FeatureVolumeVectorPostprocessorCopy);

InputParameters
FeatureVolumeVectorPostprocessorCopy::validParams()
{
...
FeatureVolumeVectorPostprocessorCopy::FeatureVolumeVectorPostprocessorCopy(
...
Real
FeatureVolumeVectorPostprocessorCopy::computeIntegral(std::size_t var_index) const
{
  Real sum = 0;
...
void
FeatureVolumeVectorPostprocessorCopy::accumulateBoundaryFaces(
    const Elem * elem,
    const std::vector<unsigned int> & var_to_features,
    std::size_t libmesh_dbg_var(num_features),
    unsigned int side)
...
Real
FeatureVolumeVectorPostprocessorCopy::computeFaceIntegral(std::size_t var_index) const
{
  Real sum = 0;
