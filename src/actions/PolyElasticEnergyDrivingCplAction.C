...
#include "PolyElasticEnergyDrivingCplAction.h"
#include "Factory.h"
#include "FEProblem.h"
#include "Conversion.h"

registerMooseAction("PhaseFieldApp", PolyElasticEnergyDrivingCplAction, "add_kernel");

InputParameters
PolyElasticEnergyDrivingCplAction::validParams()
{
...
PolyElasticEnergyDrivingCplAction::PolyElasticEnergyDrivingCplAction(
...
void
PolyElasticEnergyDrivingCplAction::act()
{
#ifdef DEBUG
  Moose::err << "Inside the PolyElasticEnergyDrivingCplAction Object\n";
  ...
  for (unsigned int op = 0; op < _op_num; ++op)
  {
    ...
    MaterialPropertyName D_stiff_name =
        derivativePropertyNameFirst(_elastic_energy_name, var_name);

    // Set name of kernel being created
    std::string kernel_type = "ACGGElasticEnergyCpl";
